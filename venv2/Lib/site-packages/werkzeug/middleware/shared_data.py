...
class SharedDataMiddleware:
    """A WSGI middleware which provides tmp content for development
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/tmp': ('myapplication', 'tmp')
        })

    This will then serve the ``tmp`` folder in the `myapplication`
    Python package.
